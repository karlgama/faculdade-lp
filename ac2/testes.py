...
# #DEVE GERAR EXCEÇÃO KEYERROR PARA NOME DE FUNCIONÁRIO NÃO CADASTRADO
# try:
#     resultado = calcular_salario(dicionario, 'paulo')
#     print('ERRO:')
#     print(' Não gerou exceção KeyError para nome não cadastrado')
# except KeyError:
#     print('CORRETO')

# #DEVE GERAR EXCEÇÃO TYPEERROR PARA CARGO INVÁLIDO
# try:
#     resultado = calcular_salario(dicionario, 'marcos')
#     print('ERRO:')
#     print(' Não gerou exceção TypeError para cargo inválido')
# except TypeError:
#     print('CORRETO')from ac02 import calcular_salario
