...
class Episodio:
    def __init__(self, numero_ep: int, temporada: int, nome: str,
                 duracao: int):
...
class Serie:
    def __init__(self, nome_serie: str):
        self.nome_serie = nome_serie
        self.episodios = []

    def incluir_episodio(self, episodio: Episodio):
        self.episodios.append(episodio)

    def buscar_episodios(self, temporada: int):
        eps = []
